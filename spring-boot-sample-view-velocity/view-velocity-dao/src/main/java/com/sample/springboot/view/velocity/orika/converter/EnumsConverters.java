package com.sample.springboot.view.velocity.orika.converter;
...
public class EnumsConverters {
    ...
    public static class SampleEnumToIntegerConverter extends BidirectionalConverter<SampleEnum, Integer> {
